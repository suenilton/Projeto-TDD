...
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'busca_animal.settings')
django.setup()
...
def gerando_animais():
    for animal in lista_animais:
        ...
        animal = Animais(nome_animal=nome, predador=predador, venenoso=venenoso, domestico=domestico)
        animal.save()
